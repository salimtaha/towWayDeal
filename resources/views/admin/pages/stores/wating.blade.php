                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('admin.stores.index') }}"> المتاجر
                                </a></li>
                                <li class="breadcrumb-item active"><a href="{{ route('admin.stores.wating') }}"> قائمه
                                    الانتظار</a></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="card product-details">
                        <div class=" product-details">
                            <form class="form-inline search-form search-box ">
                                  <div class="tect-danger ">المتاجر في قائمه الانتظار</div>
                            </form>
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('#editableTable').DataTable({
                ...
                ajax: "{{ Route('admin.stores.getallPending') }}",
                columns: [
